...
export default function EditFeastScreen() {
  ...
  function openEdit(feast) {
    ...
    setMenu(
      Array.isArray(feast.menu) ? feast.menu.join(", ") : feast.menu || "",
    );
          ...
          {feastList.length === 0 ? (
            <View style={styles.emptyBox}>
              <Text style={styles.emptyText}>
                No feasts added yet for this hall.
              </Text>
            </View>
          ) : (
            feastList.map((f) => {
              ...
              return (
                ...
                >
                  ...
                  <Text style={styles.cardMenu}>
                    {Array.isArray(f.menu)
                      ? f.menu.join(", ")
                      : f.menu || "No menu listed"}
                    {f.price ? ` • ৳${f.price}` : ""}
                  </Text>
